...
add_filter('fed_plugin_versions', function ($version){
	return array_merge($version, array(
		'custom_post' => 'Custom Post ('.FED_CP_PLUGIN_VERSION.')'
	));
});

if( !function_exists('fed_cp_get_custom_post_types') ){
	/**
	 * @param  array  $request
	 *
	 * @return array
		...
		return array(
			'Basic Settings' => array(
				'slug'          => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Post type slug', 'frontend-dashboard-custom-post'),
					)),
				),
				'label'         => array(
					...
					'required'     => true,
					'help_message' => fed_show_help_message(array(
						'content' => __('A plural descriptive name for the post type marked for translation.', 'frontend-dashboard-custom-post'),
					)),
				),
				'singular_name' => array(
					...
					'required'     => true,
					'help_message' => fed_show_help_message(array(
						'content' => __('General name for the post type, usually singular.', 'frontend-dashboard-custom-post'),
					)),
				),
				'menu_icon'     => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Custom post type menu icon', 'frontend-dashboard-custom-post'),
					)),
				),
			),
			'Label Settings' => array(
				'name'                  => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('General name for the post type, usually plural.', 'frontend-dashboard-custom-post'),
					)),
				),
				'menu_name'             => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Default is the same as \'name\'.', 'frontend-dashboard-custom-post'),
					)),
				),
				'name_admin_bar'        => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('String for use in New in Admin menu bar. Default is the same as \'singular_name\'.', 'frontend-dashboard-custom-post'),
					)),
				),
				'archives'              => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('String for use with archives in nav menus. Default is Post Archives/Page Archives.', 'frontend-dashboard-custom-post'),
					)),
				),
				'attributes'            => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Label for the attributes meta box. Default is Post Attributes/Page Attributes.', 'frontend-dashboard-custom-post'),
					)),
				),
				'parent_item_colon'     => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('This string isn\'t used on non-hierarchical types. In hierarchical ones the default is Parent Page.', 'frontend-dashboard-custom-post'),
					)),
				),
				'all_items'             => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('String for the submenu. Default is All Posts/All Pages.', 'frontend-dashboard-custom-post'),
					)),
				),
				'add_new_item'          => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Default is Add New Post/Add New Page.', 'frontend-dashboard-custom-post')
					)),
				),
				'add_new'               => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Default is Edit Post/Edit Page.', 'frontend-dashboard-custom-post'),
					)),
				),
				'new_item'              => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Default is New Post/New Page.', 'frontend-dashboard-custom-post'),
					)),
				),
				'edit_item'             => array(
				...
				'view_item'             => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Default is View Post/View Page', 'frontend-dashboard-custom-post'),
					)),
				),
				'view_items'            => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Label for viewing post type archives. Default is View Posts  /  View Pages .', 'frontend-dashboard-custom-post'),
					)),
				),
				'search_items'          => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Default is Search Posts/Search Pages', 'frontend-dashboard-custom-post'),
					)),
				),
				'not_found'             => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Default is No posts found/No pages found.', 'frontend-dashboard-custom-post'),
					)),
				),
				'not_found_in_trash'    => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Default is No posts found in Trash/No pages found in Trash.', 'frontend-dashboard-custom-post'),
					)),
				),
				'featured_image'        => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Default is Featured Image.', 'frontend-dashboard-custom-post'),
					)),
				),
				'set_featured_image'    => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Default is Set featured image.', 'frontend-dashboard-custom-post'),
					)),
				),
				'remove_featured_image' => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Default is Remove featured image.', 'frontend-dashboard-custom-post'),
					)),
				),
				'use_featured_image'    => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Default is Use as featured image.', 'frontend-dashboard-custom-post'),
					)),
				),
				'insert_into_item'      => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('String for the media frame button. Default is Insert into post/Insert into page.', 'frontend-dashboard-custom-post'),
					)),
				),
				'uploaded_to_this_item' => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('String for the media frame filter. Default is Uploaded to this post/Uploaded to this page.', 'frontend-dashboard-custom-post'),
					)),
				),
				'items_list'            => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('String for the table hidden heading.', 'frontend-dashboard-custom-post'),
					)),
				),
				'items_list_navigation' => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('String for the table pagination hidden heading.', 'frontend-dashboard-custom-post'),
					)),
				),
				'filter_items_list'     => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('String for the table views hidden heading.', 'frontend-dashboard-custom-post'),
					)),
				),
				'description'           => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('A short descriptive summary of what the post type is.', 'frontend-dashboard-custom-post'),
					)),
				),
				'menu_position'         => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('The position in the menu order the post type should appear', 'frontend-dashboard-custom-post'),
					)),
				),
				'capability_type'       => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('The string to use to build the read, edit, and delete capabilities.', 'frontend-dashboard-custom-post'),
					)),
				),
			),
			'Settings'       => array(
				'hierarchical'        => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Whether the post type is hierarchical (e.g. page). Allows Parent to be specified. The supports parameter should contain page-attributes to show the parent select box on the editor page.', 'frontend-dashboard-custom-post'),
					)),
				),
				'public'              => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Controls how the type is visible to authors (show_in_nav_menus, show_ui) and readers (exclude_from_search, publicly_queryable).', 'frontend-dashboard-custom-post'),
					)),
				),
				'show_ui'             => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Whether to generate a default UI for managing this post type in the admin.', 'frontend-dashboard-custom-post'),
					)),
				),
				'show_in_menu'        => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Where to show the post type in the admin menu', 'frontend-dashboard-custom-post'),
					)),
				),
				'show_in_admin_bar'   => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Whether to make this post type available in the WordPress admin bar', 'frontend-dashboard-custom-post'),
					)),
				),
				'show_in_nav_menus'   => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Whether post_type is available for selection in navigation menus', 'frontend-dashboard-custom-post'),
					)),
				),
				'can_export'          => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Can this post_type be exported.', 'frontend-dashboard-custom-post'),
					)),
				),
				'has_archive'         => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Enables post type archives. Will use $post_type as archive slug by default.', 'frontend-dashboard-custom-post'),
					)),
				),
				...
				'publicly_queryable'  => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Whether queries can be performed on the front end as part of parse_request()', 'frontend-dashboard-custom-post'),
					)),
				),
				'query_var'           => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Sets the query_var key for this post type.', 'frontend-dashboard-custom-post'),
					)),
				),
				'delete_with_user'    => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Whether to delete posts of this type when deleting a user. If true, posts of this type belonging to the user will be moved to trash when then user is deleted. If false, posts of this type belonging to the user will not be trashed or deleted.', 'frontend-dashboard-custom-post'),
					)),
				),
				'show_in_rest'        => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Whether to expose this post type in the REST API.', 'frontend-dashboard-custom-post'),
					)),
				),
				'rest_base'           => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('The base slug that this post type will use when accessed using the REST API.', 'frontend-dashboard-custom-post'),
					)),
				),
				'rewrite'             => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Triggers the handling of rewrites for this post type. To prevent rewrites, set to false.', 'frontend-dashboard-custom-post'),
					)),
				),
				'rewrite_slug'        => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Slug to rewrite the default url base', 'frontend-dashboard-custom-post'),
					)),
				),
			),
...
if( !function_exists('fed_cp_get_taxonomies_label') ){
	/**
	 * @param  array  $request
	 *
	 * @return array
	...
	function fed_cp_get_taxonomies_label(array $request = array()){
		return apply_filters('fed_cp_get_taxonomies_label', array(
			'Basic Settings' => array(
				'slug'          => array(
				...
				'label'         => array(
					...
					'required'     => true,
					'help_message' => fed_show_help_message(array(
						'content' => __(' A plural descriptive name for the taxonomy marked for translation.','frontend-dashboard-custom-post')
					)),
				),
				'singular_name' => array(
					'name'         => __('Singular Name', 'frontend-dashboard-custom-post'),
					...
					'required'     => true,
					'help_message' => fed_show_help_message(array(
						'content' => __('General name for the taxonomy, usually singular.','frontend-dashboard-custom-post')
					)),
				),
				'fed_extra'     => array(
			...
			'Label Settings' => array(
				'name'                       => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('General name for the taxonomy, usually plural.','frontend-dashboard-custom-post')
					)),
				),
				'menu_name'                  => array(
					'name'         => __('Menu Name', 'frontend-dashboard-custom-post'),
				...
				'new_item_name'              => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Default is New Item Name','frontend-dashboard-custom-post')
					)),
				),
				'edit_item'                  => array(
					'name'         => __('Edit Item', 'frontend-dashboard-custom-post'),
				...
				'update_item'                => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Default is Update Item','frontend-dashboard-custom-post')
					)),
				),
				'parent_item'                => array(
				...
				'description'                => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('A short descriptive summary of what the taxonomy is.','frontend-dashboard-custom-post')
					)),
				),
				'popular_items'              => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('The popular items text. This string is not used on hierarchical taxonomies. Default is Popular Tags or null','frontend-dashboard-custom-post')
					)),
				),
				'separate_items_with_commas' => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('The separate item with commas text used in the taxonomy meta box. This string is not used on hierarchical taxonomies. Default is __( \'Separate tags with commas\' ), or null','frontend-dashboard-custom-post')
					)),
				),
				'add_or_remove_items'        => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('the add or remove items text and used in the meta box when JavaScript is disabled. This string is not used on hierarchical taxonomies. Default is __( \'Add or remove tags\' ) or null','frontend-dashboard-custom-post')
					)),
				),
				'choose_from_most_used'      => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('the choose from most used text used in the taxonomy meta box. This string is not used on hierarchical taxonomies. Default is __( \'Choose from the most used tags\' ) or null','frontend-dashboard-custom-post')
					)),
				),
			),
			'Settings'       => array(
				'hierarchical'       => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Whether the taxonomy is hierarchical (e.g. page). Allows Parent to be specified. The supports parameter should contain page-attributes to show the parent select box on the editor page..','frontend-dashboard-custom-post')
					)),
				),
				'show_tagcloud'      => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Whether to allow the Tag Cloud widget to use this taxonomy.','frontend-dashboard-custom-post')
					)),
				),
				'show_in_quick_edit' => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Whether to show the taxonomy in the quick/bulk edit panel','frontend-dashboard-custom-post')
					)),
				),
				'show_admin_column'  => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Whether to allow automatic creation of taxonomy columns on associated post-types table','frontend-dashboard-custom-post')
					)),
				),
				'sort'               => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Whether this taxonomy should remember the order in which terms are added to objects','frontend-dashboard-custom-post')
					)),
				),
				'public'             => array(
					'name'         => __('Public', 'frontend-dashboard-custom-post'),
				...
				'show_ui'            => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Whether to generate a default UI for managing this taxonomy in the admin.','frontend-dashboard-custom-post')
					)),
				),
				'show_in_menu'       => array(
					'name'         => __('Show in Menu', 'frontend-dashboard-custom-post'),
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Where to show the taxonomy in the admin menu','frontend-dashboard-custom-post')
					)),
				),
				'show_in_nav_menus'  => array(
					'name'         => __('Show in Nav Menus', 'frontend-dashboard-custom-post'),
				...
				'query_var'          => array(
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Sets the query_var key for this taxonomy.','frontend-dashboard-custom-post')
					)),
				),
				'show_in_rest'       => array(
					'name'         => __('Show in REST', 'frontend-dashboard-custom-post'),
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Whether to expose this taxonomy in the REST API.','frontend-dashboard-custom-post')
					)),
				),
				'rest_base'          => array(
					'name'         => __('REST base', 'frontend-dashboard-custom-post'),
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('The base slug that this taxonomy will use when accessed using the REST API.','frontend-dashboard-custom-post')
					)),
				),
				'rewrite'            => array(
					'name'         => __('Rewrite URL', 'frontend-dashboard-custom-post'),
					...
					'help_message' => fed_show_help_message(array(
						'content' => __('Triggers the handling of rewrites for this taxonomy. To prevent rewrites, set to false.', 'frontend-dashboard-custom-post')
					)),
				),
				'rewrite_slug'       => array(
					'name'         => __('Rewrite URL Slug', 'frontend-dashboard-custom-post'),
...
if( !function_exists('fed_cp_get_all_taxonomies') ){
	/**
	 * @return array
	 */
...
if( !function_exists('fed_cp_get_taxonomies') ){
	/**
	 * @param  array  $array
	 *
	 * @return array
	...
	//function fed_cp_get_taxonomies(array $array = array('show_ui' => true))
	function fed_cp_get_taxonomies(array $array = array()){
		return get_taxonomies($array, 'objects');
	}
}

if( !function_exists('fed_cp_get_taxonomies_key_key') ){
	/**
	 * @return array
	 */
...
if( !function_exists('fed_cp_get_post_types_key_key') ){
	/**
	 * @return array
	 */
...
if( !function_exists('fed_cp_checkbox_taxonomies') ){
	/**
	 * @param  array  $request
	 *
	 * @return array
...
if( !function_exists('fed_cp_checkbox_taxonomies_with_users') ){
	/**
	 * @param  array  $request
	 * @param  null  $tax_name
	 *
...
if( !function_exists('fed_cp_customize_post_for_user_role') ){
	/**
	 *
	 * @param  array  $request
	 * @param  null  $tax_name
...
if( !function_exists('fed_cp_checkbox_post_type') ){
	/**
	 * @param  array  $request
	 *
	 * @return array
	...
	function fed_cp_checkbox_post_type(array $request = array()){
		$taxonomies = apply_filters('fed_cp_checkbox_post_type', fed_get_public_post_types(), $request);
...
if( !function_exists('fed_cp_default_custom_post_types_key') ){
	/**
	 * @return array
	 */
	function fed_cp_default_custom_post_types_key(){
		...
		$taxonomies = array(
			'taxonomies' => fed_cp_get_taxonomies_key_key()
		);
...
if( !function_exists('fed_cp_default_taxonomies_key') ){
	/**
	 * @return array
	 */
	function fed_cp_default_taxonomies_key(){
		...
		$object_type = array(
			'object_type' => fed_cp_get_post_types_key_key()
		);
...
if( !function_exists('fed_cp_default_taxonomies') ){
	/**
	 * @return array
	 */
...
if( !function_exists('fed_cp_custom_menu_icons_popup') ){
	/**
	 *
	 */
	function fed_cp_custom_menu_icons_popup(){
		?><div class="bc_fed">
			<div class="modal fade fed_show_fa_list" tabindex="-1" role="dialog">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="row fed_fa_container"><?php 
								foreach( fed_dashicon_list() as $key => $list ){
...
if( !function_exists('fed_dashicon_list') ){
	/**
	 * @return array
	 */
...
if( !function_exists('fed_cp_is_user_can_edit_post') ){
	/**
...
if( !function_exists('fed_cp_is_user_can_delete_post') ){
	/**
	 * @param  string  $post_type
	 *
	 * @return bool
...
if( !function_exists('fed_cp_is_user_can_view_post') ){
	/**
	 * @param  string  $post_type
	 *
	 * @return bool
...
if( !function_exists('fed_cp_is_user_can_add_post') ){
	/**
	 * @param  string  $post_type
	 *
	 * @return bool
